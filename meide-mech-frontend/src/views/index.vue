<template>
  <ion-page>
    <ion-content>
      <section name="header-carousel" id="home">
        <nav class="navbar navbar-light justify-content-center montserrat" style="background: url('assets/images/batik.svg'); background-color: #e31528;">
          ...
          <div class="row mt-2">
            <div class="flex-nowrap d-flex">
              <img src="assets/figma_assets/certified.svg" alt="" style="width: 26px; margin: 12px 16px 14px;">
            ...
            <div class="flex-nowrap d-flex">
              <img src="assets/figma_assets/trophy.svg" alt="" style="width: 26px; margin: 12px 16px 14px;">
          ...
          <div class="row clearfix">
            ...
            <div class="about-column col-lg-8 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="row clearfix">
                ...
                <div class="inner-content-column col-md-8 col-sm-7 col-xs-12">
                  <div class="text">
      ...
      <section class="contact-section" id="contact-us">
        <div class="auto-container px-3 px-md-5 px-lg-3">
          <div class="row clearfix">
            <!--Info Column-->
            <div class="info-column col-md-12 col-lg-8 col-sm-12 col-xs-12">
              <!--Sec Title-->
              <div class="sec-title">
      ...
      <footer class="main-footer-two">
        <div class="auto-container">
          ...
          <div class="info-section">
            <div class="row">
              <div class="left-column col-md-4 col-sm-12">
                <div class="inner-box">
                  <div class="icon-box">
            ...
            <div class="row clearfix">
              ...
              <div class="big-column col-md-6 col-sm-12 col-xs-12">
                <div class="row clearfix">
                  ...
                  <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-widget-two logo-widget">
                      ...
                      <div class="widget-content">
                        <div class="text">
                          The world's leading manufacturer and solution
                  ...
                  <!--Footer Column-->
                  <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-widget-two links-widget-two">
                      <h2>Usefull links</h2>
                      <ul class="links">
                ...
                <div class="row clearfix">
                  ...
                  <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-widget-two links-widget-two">
                      <h2>SOLUTION</h2>
                      <ul class="links">
                        <li><a href="#">Grooved Coupling</a></li>
                  ...
                  <!--Footer Column-->
                  <div class="footer-column col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-widget-two working-hour-widget">
                      <h2>Working Hours</h2>
                      <ul>
                        <li>
                          Mon to Friday &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
                        ...
                        <li>
                          ...
                          :
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <span class="theme_color">Closed</span>
                        </li>
                      </ul>
                    </div>
                  </div>
...
.our-product::-webkit-scrollbar-thumb {
  background: #c1c1c1;
  border-radius: 25px;
