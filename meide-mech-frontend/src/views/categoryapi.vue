                                    ...
                                    <aside class="sidebar default-sidebar">
                                        ...
                                        <div class="sidebar-widget sidebar-blog-category">
                                            ...
                                            <div v-for="post in posts" v-bind:key="post.id">
                                                <button class="accordion">{{ post.name }}</button>
                                                <ul v-for="s in sub" v-bind:key="s.id">
                                                    <li v-if="post.id == s.parent_category_id">{{ s.name }}</li>
                                                </ul>
                                            </div>
                                        ...
                                        <div class="search-box-product">
                                            <form method="post"
                                                ...
                                                <div class="form-group">
                                                    <input type="search" name="search-field-product" value=""
                                                                ...
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            ...
                                                                            class="prod-title">GROOVED WET ALARM CHECK
                                                                            VALVE, FIG#
                                                                            ZSFZ8X9</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">AWWA FLANGED RESILIENT
                                                                            OS&Y GATE
                                                                            VALVE,FIG# XZ41X</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">ANSI WAFER BUTTERFLY
                                                                            VALVE WITH
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">EN FLANGED WET ALARM
                                                                            CHECK VALVE, FIG#
                                                                            ZSFZ4X</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">ANSI FLANGED SWING CHECK
                                                                            VALVE, FIG#
                                                                            H44X2</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">BS FLANGED METAL SEATED
                                                                            GLOBE VALVE, FIG#
                                                                            J41H</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">UNDERGROUND FIRE HYDRANT,
                                                                            FIG# SA1</a>
                                                                    </h5>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">BS FLANGED RESILIENT NRS
                                                                            GATE VALVE,FIG#
                                                                            Z45X</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">BS FLANGED RESILIENT OS&Y
                                                                            GATE VALVE,FIG#
                                                                            XZ41X</a>
                                                                    </h5>
                                                                </div>
                                                            ...
                                                            <div class="clearfix_">
                                                                <div class="pull-left">
                                                                    <h5>
                                                                        <a href="javascript:void(0);"
                                                                            onclick="popupDetailProduct();"
                                                                            class="prod-title">DIN FLANGED RESILIENT NRS
                                                                            GATE VALVE,FIG#
                                                                            Z45X</a>
                                                                    </h5>
                                                                </div>
...
export default defineComponent({
    ...
    methods: {
        fetchPosts() {
            axios
                .get("http://localhost:8080/api/getcategory")
                .then((response) => {
        ...
        fetchSub() {
            axios
                .get("http://localhost:8080/api/getsubcategory")
                .then((response) => {
